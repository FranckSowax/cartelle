          ...
          {autoInactivity && (
            <div className="mt-4 pl-[52px]">
              ...
              <input
                ...
                className="w-32 px-3 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-teal-50/30 transition-all duration-200"
              />
          ...
          {autoMilestone && (
            <div className="mt-4 pl-[52px]">
              ...
              <input
                ...
                className="w-full max-w-sm px-3 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-teal-50/30 transition-all duration-200"
              />
              <p className="text-xs text-gray-400 mt-1">
